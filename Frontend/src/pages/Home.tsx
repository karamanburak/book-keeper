    ...
    return (
        <div>
            ...
            <div className=" flex justify-center items-stretch gap-6 mt-6 flex-wrap">
                {data.map((data) => (
                    <div key={data._id} className="w-full max-w-sm bg-white border text-center rounded-lg">
                        ...
                        <div className="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">ISBN: {data.ISBN}</p>
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Publication Year: {data.publicationYear}</p>
                            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Genre: {data.genre}</p>
                        </div>
